...
import { PedidosResultUsuario } from "../components/pedidosusuario-result";
import { PedidosListToolbarUsuario } from "../components/pedidosusuario-toolbar";
import { pedidousuarios } from "../__mocks__/pedidosusuarios";
import Api from "../services/Api";
import Cookies from "universal-cookie";
import * as XLSX from "xlsx/xlsx.mjs";

const cookies = new Cookies();
class PedidosUsuario extends React.Component {
  constructor(props) {
    super(props);
  }
  state = {};
      ...
      <>
        ...
        >
          <Container maxWidth={false}>
            <PedidosListToolbarUsuario />
            <Box sx={{ mt: 3 }}>
              <PedidosResultUsuario pedidousuarios={pedidousuarios} />
            </Box>
          </Container>
        </Box>
      </>
